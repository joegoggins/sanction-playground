...
Initially this rails app will be a bit ugly, but potentially could eventually become a nice authoritative reference example of how sanction + sanction_ui work in practice
